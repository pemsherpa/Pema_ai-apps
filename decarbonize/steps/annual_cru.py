...
class CRUAnnualStep(DecarbStep):
    def __init__(self, rec,cru_step):
        super().__init__(DecarbStepType.CRU_ANNUAL, cru_step.cur_cost, cru_step.new_cost, cru_step.cur_emissions, cru_step.new_emissions, cru_step.description, cru_step.difficulty)
        self.rec=rec
