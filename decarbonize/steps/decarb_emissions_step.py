...
class FlightOptimizerDecarbStep(DecarbStep):
    ...
    def __init__(self, cur_cost, new_cost, cur_emissions, new_emissions, description, difficulty, transition_percentage,num_stops):
        super().__init__(DecarbStepType.FLIGHT_OPTIMIZER, cur_cost, new_cost, cur_emissions, new_emissions, description, difficulty,transition_percentage)
