...
class SMUSector_simplified:
   ...
   def __init__(self, user_input_peak_usage, user_input_part_peak_usage, user_input_super_off_peak_usage, user_input_off_peak_usage,meter_input,time_in_use,max_15min_usage, user_sector,user_B1STU_highest_demand_15mins):
        import pandas as pd
        self.Unbundled_peak_time_df = pd.read_excel('Electricity Rate Plan.xlsx', sheet_name='Unbundled Peak Time Price')
        ...
        if plan in ( 'B-10_SV', 'B-10_PV','B-10_TV','B-1'):
          for season in self.seasons:
           if season == 'Summer':
             ...
             peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Peak')&(self.Unbundled_peak_time_df['Season']=='Summer')]
             part_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Part-Peak')& (self.Unbundled_peak_time_df['Season']=='Summer')]
             off_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Off-Peak')&(self.Unbundled_peak_time_df['Season']=='Summer')]
             ...
             self.B10SVUW_off_peak_usage = winter_off_peak_usage

             self.B10PVUWpeak_usage = winter_peak_usage
             self.B10PVUWsuperoff_peak_usage = winter_super_off_peak_usage
             ...
             peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Peak')&(self.Unbundled_peak_time_df['Season']=='Winter')]
             super_off_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Super-Off-Peak')& (self.Unbundled_peak_time_df['Season']=='Winter')]
             off_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Off-Peak')&(self.Unbundled_peak_time_df['Season']=='Winter')]
        ...
        if plan=='B-1-ST':
          for season in self.seasons:
            if season == 'Summer':
                 ...
                 super_off_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Super-Off-Peak')& (self.Unbundled_peak_time_df['Season']=='Winter')]
                 off_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Off-Peak')&(self.Unbundled_peak_time_df['Season']=='Winter')]
                 part_peak_df = self.Unbundled_peak_time_df[(self.Unbundled_peak_time_df['Sector'] == self.user_sector) & (self.Unbundled_peak_time_df['Plan'] == plan) &(self.Unbundled_peak_time_df['Type']=='Part-Peak')&(self.Unbundled_peak_time_df['Season']=='Winter')]
